...
export default function Letter() {
  return (
    <section style={{
      ...
      background: 'linear-gradient(180deg, #8B1A1A 0%, #6B1515 50%, #4A0E0E 100%)',
      overflow: 'hidden',
      display: 'flex',
        ...
        {[...Array(20)].map((_, i) => (
          <div
            ...
            style={{
              position: 'absolute',
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(255, 215, 0, 0.3) 0%, rgba(255, 192, 203, 0.2) 40%, transparent 70%)',
        ...
        {[...Array(50)].map((_, i) => (
          <div
            ...
            style={{
              ...
              animation: `confettiFall ${Math.random() * 8 + 6}s linear infinite`,
              animationDelay: `${Math.random() * 5}s`,
